...
public class AdminPane extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        cmbUType.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "User", "Admin" }));
            ...
            .addGroup(jPanel15Layout.createSequentialGroup()
                ...
                .addGroup(jPanel15Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel15Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(txtcategoryadd, javax.swing.GroupLayout.PREFERRED_SIZE, 204, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel15Layout.createSequentialGroup()
                        .addGap(40, 40, 40)
        ...
        jTabbedPane2.addTab("Taelent", jPanel25);
        ...
        try {
            ...
            if (jTable4.getModel().getRowCount() > 0) {
                if (jTable4.getSelectedRowCount() == 1) {
                    ...
                    int id = (Integer) jTable4.getModel().getValueAt(rowIndex, 0);
                    String Pstatus = tblDuration.getModel().getValueAt(rowIndex, 1).toString();
                    String sql2 = "DELETE FROM `user` WHERE id = '" + sid.getId() + "'";
                    d.statement.executeUpdate(sql2);
                    JOptionPane.showMessageDialog(null, "ok");
                    mdlInv.removeRow(rowIndex);
                } else {
