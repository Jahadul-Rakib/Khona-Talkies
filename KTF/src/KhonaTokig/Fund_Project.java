...
public class Fund_Project extends javax.swing.JFrame {
    ...
    private void btSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btSaveActionPerformed
        int projectsId = FundPojo.getId();
        int fundsId = IdStore.getId();
        try {
    ...
    public void getSaveFundProject() {
        try {
            String sql = "SELECT project.title, project.director, project.category FROM fund,project_fund, project WHERE project.id = project_fund.project_id and project_fund.fund_id = fund.id and fund.id = '" + IdStore.getId() + "'";
