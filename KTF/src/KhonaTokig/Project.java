...
public class Project extends javax.swing.JFrame {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        int festivalId = IdStore.getId();
        int ProjectId = ProjectPojo.getId();
        try {
            String fundAndProject = "select * from `festival_project` where `project_id`='" + ProjectId + "' AND `festival_id`='" + festivalId + "'";
            ResultSet rs = d.statement.executeQuery(fundAndProject);
            if (rs.next()) {
                JOptionPane.showMessageDialog(null, "Your are Already Save this. ");
            } else {
                String Quary = "INSERT INTO `festival_project`(`project_id`, `festival_id`) VALUES ('" + ProjectId + "','" + festivalId + "')";
    ...
    public void getSaveProject() {
        try {
            String sql = "SELECT project.title, project.director, project.category FROM festival,festival_project, project WHERE project.id = festival_project.project_id and festival_project.festival_id = festival.id and festival.id = '" + IdStore.getId() + "'";
